...
#include "../../headers/terrain.editor/CTerrainSceneNode.h"
#include "../../headers/terrain.editor/CTerrainTriangleSelector.h"
#include "IVideoDriver.h"
#include "ISceneManager.h"
#include "ICameraSceneNode.h"
#include "SViewFrustum.h"
#include "irrMath.h"
#include "../../headers/terrain.editor/os.h"
#include "IGUIFont.h"
...
namespace irr {
    namespace scene {
        ...
        bool CTerrainSceneNode::loadHeightMapRAW(io::IReadFile* file,
            ...
            if (!width)
                TerrainData.Size = core::floor32(core::squareroot(((f32) (filesize / bytesPerPixel))));
            else {
        ...
        void CTerrainSceneNode::preRenderCalculationsIfNeeded() {
            ...
            if (!ForceRecalculation) {
                if ((core::abs_(cameraRotation.X - OldCameraRotation.X) < CameraRotationDelta) &&
                        (core::abs_(cameraRotation.Y - OldCameraRotation.Y) < CameraRotationDelta)) {
                    if ((core::abs_(cameraPosition.X - OldCameraPosition.X) < CameraMovementDelta) &&
                            (core::abs_(cameraPosition.Y - OldCameraPosition.Y) < CameraMovementDelta) &&
                            (core::abs_(cameraPosition.Z - OldCameraPosition.Z) < CameraMovementDelta)) {
                        if (core::abs_(CameraFOV - OldCameraFOV) < CameraFOVDelta &&
