...
${OBJECTDIR}/CMasterEventReceiver.o: CMasterEventReceiver.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../../Irrlicht/irrlicht-1.8/include `pkg-config --cflags gl` `pkg-config --cflags xxf86vm`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/CMasterEventReceiver.o CMasterEventReceiver.cpp

${OBJECTDIR}/CGUIMainMenu.o: CGUIMainMenu.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../../Irrlicht/irrlicht-1.8/include `pkg-config --cflags gl` `pkg-config --cflags xxf86vm`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/CGUIMainMenu.o CGUIMainMenu.cpp
...
${OBJECTDIR}/_ext/584002442/CMultiTexturingManager.o: ../IrrlichtTest/CMultiTexturingManager.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I../../Irrlicht/irrlicht-1.8/include `pkg-config --cflags gl` `pkg-config --cflags xxf86vm`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/584002442/CMultiTexturingManager.o ../IrrlichtTest/CMultiTexturingManager.cpp

${OBJECTDIR}/Main.o: Main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../../Irrlicht/irrlicht-1.8/include `pkg-config --cflags gl` `pkg-config --cflags xxf86vm`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/Main.o Main.cpp

${OBJECTDIR}/CSceneNodeAnimatorCameraTerrain.o: CSceneNodeAnimatorCameraTerrain.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../../Irrlicht/irrlicht-1.8/include `pkg-config --cflags gl` `pkg-config --cflags xxf86vm`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/CSceneNodeAnimatorCameraTerrain.o CSceneNodeAnimatorCameraTerrain.cpp
