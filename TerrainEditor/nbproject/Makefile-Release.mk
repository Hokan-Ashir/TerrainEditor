...
${OBJECTDIR}/src/CMultiTexturingTerrainSceneNode.o: src/CMultiTexturingTerrainSceneNode.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../Irrlicht/irrlicht-1.8/include `pkg-config --cflags gl` `pkg-config --cflags xxf86vm`   -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/CMultiTexturingTerrainSceneNode.o src/CMultiTexturingTerrainSceneNode.cpp
...
${OBJECTDIR}/src/TextureTools.o: src/TextureTools.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../Irrlicht/irrlicht-1.8/include `pkg-config --cflags gl` `pkg-config --cflags xxf86vm`   -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/TextureTools.o src/TextureTools.cpp
...
${OBJECTDIR}/src/terrain.editor/CTerrainSceneNode.o: src/terrain.editor/CTerrainSceneNode.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/terrain.editor
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../Irrlicht/irrlicht-1.8/include `pkg-config --cflags gl` `pkg-config --cflags xxf86vm`   -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/terrain.editor/CTerrainSceneNode.o src/terrain.editor/CTerrainSceneNode.cpp

${OBJECTDIR}/src/terrain.editor/CTerrainTriangleSelector.o: src/terrain.editor/CTerrainTriangleSelector.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/terrain.editor
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../Irrlicht/irrlicht-1.8/include `pkg-config --cflags gl` `pkg-config --cflags xxf86vm`   -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/terrain.editor/CTerrainTriangleSelector.o src/terrain.editor/CTerrainTriangleSelector.cpp
...
${OBJECTDIR}/src/terrain.editor/decal.system/CBatchingMesh.o: src/terrain.editor/decal.system/CBatchingMesh.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../Irrlicht/irrlicht-1.8/include `pkg-config --cflags gl` `pkg-config --cflags xxf86vm`   -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/terrain.editor/decal.system/CBatchingMesh.o src/terrain.editor/decal.system/CBatchingMesh.cpp

${OBJECTDIR}/src/terrain.editor/decal.system/DecalManager.o: src/terrain.editor/decal.system/DecalManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/terrain.editor/decal.system
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../Irrlicht/irrlicht-1.8/include `pkg-config --cflags gl` `pkg-config --cflags xxf86vm`   -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/terrain.editor/decal.system/DecalManager.o src/terrain.editor/decal.system/DecalManager.cpp

${OBJECTDIR}/src/terrain.editor/decal.system/DecalSceneNode.o: src/terrain.editor/decal.system/DecalSceneNode.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/terrain.editor/decal.system
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../Irrlicht/irrlicht-1.8/include `pkg-config --cflags gl` `pkg-config --cflags xxf86vm`   -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/terrain.editor/decal.system/DecalSceneNode.o src/terrain.editor/decal.system/DecalSceneNode.cpp
